...
def parse_args(input_args=None):
    ...
    parser.add_argument('--configs_yml', type = str, default = 'configs/v1_resnet_3dpw_ft.yml', help = 'settings') 
    ...
    # model settings
    model_group.add_argument('--backbone',type = str,default = 'resnet',help = 'backbone model: resnet50 or hrnet')
    ...
    config_yml_path = os.path.join(code_dir, parsed_args.configs_yml)
